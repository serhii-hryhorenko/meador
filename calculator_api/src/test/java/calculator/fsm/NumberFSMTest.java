...
class NumberFSMTest extends AbstractResolvingTest {
    ...
    void testNull() {
        ...
        nullPointerTester.testAllPublicConstructors(NumberFSM.class);
        nullPointerTester.testAllPublicInstanceMethods(NumberFSM.create(new ExceptionThrower<>(
