...
class UnaryOperatorTest extends MeadorTest {
    ...
    static Stream<Arguments> positiveCases() {
        return Stream.of(
                ...
                of("a = pi(); b = a~; print(~b, a);", "[3.0, 3.0]",
                   "Integer cast operator is broken."),
                of("a = 5 != 1; print(not a);", "[false]", "Negation operator is broken."),
                of("a = 1; print(sum(a++, ±a, !a));", "[1.0]",
                   "Operator returned values are wrong."),
                of("a = 1; print(++a, a);", "[2.0, 2.0]", "Prefix mutation is broken."),
                of("a = 1; b = ++a >= a++; print(not b, a);", "[false, 3.0]",
                   "Unary operator is broken.")
        );
    }
    ...
    static Stream<Arguments> negativeCases() {
        return Stream.of(
                ...
                of("a = 4; print(!++a);",
                   "Two prefix unary operators with one operand were ignored."),
                of("a = 4; print(a~!);",
                   "Two postfix unary operators with one operand were ignored."),
