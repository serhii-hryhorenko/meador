package com.teamdev.meador.compiler.conditionaloperator;
...
import com.teamdev.meador.compiler.conditionaloperator.fsmimpl.ConditionalOperatorMachine;
import com.teamdev.meador.compiler.conditionaloperator.fsmimpl.ConditionalOperatorOutputChain;
            ...
            return Optional.of(new Command() {
                ...
                public void execute(RuntimeEnvironment runtimeEnvironment) throws
                    ...
                    for (var operator : context.conditionalOperators()) {
                        if (operator.condition().checkCondition(runtimeEnvironment)) {
                            operator.statements()
