...
public class VariableDeclarationMachine extends FiniteStateMachine<VariableHolder, CompilingException> {
    ...
    private VariableDeclarationMachine(TransitionMatrix<VariableHolder, CompilingException> transitionMatrix) {
        super(transitionMatrix, new ExceptionThrower<>(CompilingException::new));
    }

    public static VariableDeclarationMachine create(StateAcceptor<VariableHolder, CompilingException> expressionAcceptor) {
